    ...
    <body>
        ...
        <div class="container">
          <div class="alert alert-warning" role="alert">
              This is the pre-beta version of MetaFleet, by MetaJets, and does not have proper functionality. Visit <span><a href='https://github.com/mac-lawson/MetaFleet'>my GitHub</a></span> to check for the v1.0 release. The License is available <span><a href='/LICENSE'>here.</a></span>
          </div>
        </div>
        <!-- end -->
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title" id="staticBackdropLabel">Deploy New Assets to MetaFleet</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
              </div>
              <div class="modal-body">
              <div class="container-sm" >
              <div class="input-group mb-3">
                <span class="input-group-text" id="inputGroup-sizing-default">VR Asset Name</span>
...
<!-- remove me -->
          ...
          <div class="input-group mb-3">
            ...
            <input id="assetIP" type="text" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default">
          </div>
